...
$(function () {
    ...
    $("#tbl_IncidentList").jqGrid({
        ...
        width: 700,
        autowidth: true,
        colNames: ['QRCCodeID', 'Vehicle No', 'Driver Name', 'Accident Date', 'Number Of Injuries', 'Preventability','Incident Description', 'Incident Image','IncidentID', 'Actions'],
       ...
       // { name: 'VehicleIdentificationNo', width: 30, sortable: true },
        ...
        { name: 'IncidentID', width: 40, sortable: false, hidden: true },
