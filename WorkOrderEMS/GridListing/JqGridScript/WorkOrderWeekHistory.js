$(function () {
    ...
    $("#tbl_HistoryWorkRequestAssignmentList").jqGrid({
        url: '../GridListing/JqGridHandler/WorkOrderWeekHistory.ashx?UserID=' + $_UserID,
        datatype: 'json',
        height: 400,
        width: 700,
        mtype: 'POST',
...
function gridReload() {
    ...
    jQuery("#tbl_HistoryWorkRequestAssignmentList").jqGrid('setGridParam', { url: '../workorderems/GridListing/JqGridHandler/WorkOrderWeekHistory.ashx?UserID=' + $_UserID + "&txtSearch=" + txtSearch, page: 1 }).trigger("reloadGrid");
}
