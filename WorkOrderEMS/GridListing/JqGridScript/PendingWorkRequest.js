$(function () {
    ...
    $("#tbl_WorkRequestAssignmentList").jqGrid({
        url: '../GridListing/JqGridHandler/PendingWorkRequests.ashx?UserID=' + $_UserID,
        datatype: 'json',
        height: 400,
        width: 700,
        mtype: 'POST',
        ...
        colModel: [{ name: 'WorkRequestType', width: 100, sortable: true, hidden: true },
                  ...
                  { name: 'AssignToUserName', width: 100, sortable: false, hidden: true },
...
function PendingGridReload() {
    ...
    jQuery("#tbl_WorkRequestAssignmentList").jqGrid('setGridParam', { url: '../workorderems/GridListing/JqGridHandler/PendingWorkRequests.ashx?UserID=' + $_UserID + "&txtSearch=" + txtSearch, page: 1 }).trigger("reloadGrid");
}
