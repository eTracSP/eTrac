...
$(function () {
    ...
    $("#tbl_ManagerList").jqGrid({
        ...
        autowidth: true,
        colNames: ['Name', 'Email', 'User Type', 'DOB', 'Profile Image', 'Actions'],
...
function gridReload() {
    ...
    jQuery("#tbl_ManagerList").jqGrid('setGridParam', { url: ListUserUrl + "?txtSearch=" + txtSearch + "&UserType=" + UserType.toString() + "&page: 1" }).trigger("reloadGrid");
}
