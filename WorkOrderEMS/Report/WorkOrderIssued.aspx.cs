...
{
    public partial class WorkOrderIssued : System.Web.UI.Page
    {
            ...
            
            {
                ...
                try 
                {
                    if (System.Web.HttpContext.Current.Session["eTrac"] != null)
                    {
                        ...
                        if (projectType == 0)
                        {
                            rds = new ReportDataSource("DataSet_WorkOrderIssued", objReportManager.GetWorkOrderListForLocation(ObjLoginModel.LocationID,
                                                                                                                                    FromDate,
                                                                                                                                    ToDate,
                                                                                                                                     null,
                                                                                                                                     sSearchBy));
                        ...
                        ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportRDLC/WorkOrderIssued.rdlc");
            ...
            ReportDataSource rds = null;
             try
             {
                 if (System.Web.HttpContext.Current.Session["eTrac"] != null)
                 {
                     ...
                     objReportParameter.Add(new ReportParameter("FromDate", FromDate, true));
                     objReportParameter.Add(new ReportParameter("ToDate", ToDate, true));
                     ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/ReportRDLC/WorkOrderIssued.rdlc"); //string.Format(@"Reports\{0}.rdl", rptName);
                     ReportViewer1.LocalReport.SetParameters(objReportParameter);
                     ReportViewer1.LocalReport.DataSources.Clear();
                     ReportViewer1.LocalReport.DataSources.Add(rds);
                     ReportViewer1.LocalReport.Refresh();
        ...
        protected void btnSearchForAll_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (System.Web.HttpContext.Current.Session["eTrac"] != null)
                {
                    ...
                    if (projectType == 0)
                    {
                        rds = new ReportDataSource("DataSet_WorkOrderIssued", objReportManager.GetWorkOrderListForLocation(null,
                                                                                                                                FromDate,
                                                                                                                                ToDate,
                                                                                                                                 null,
                                                                                                                                 sSearchBy));
