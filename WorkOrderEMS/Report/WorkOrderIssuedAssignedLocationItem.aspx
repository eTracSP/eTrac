<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkOrderIssuedAssignedLocationItem.aspx.cs" Inherits="WorkOrderEMS.Report.WorkOrderIssuedAssignedLocationItem" %>
    ...
    <form id="form1" runat="server">
     <div class="panel panel-defaultReport">
        <div class="panel-headingReport">
            Work Order Issued For Location Item
        </div>
        ...
        <div class="pagi">
            ...
            <table id="appointment">
                ...
                <tr>                   
                     <td class="auto-style1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Label runat="server" ID="lblQRCName" Text="QRC Name" class="lab07" Style="font-weight: 700"></asp:Label>
                    </td>
                    <td>
                        <asp:DropDownList runat="server" ID="ddlQRCName" class="form-control">
                        </asp:DropDownList>
                    </td>
                    <td>
