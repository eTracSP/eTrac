...
namespace WorkOrderEMS.Data.RepositaryContext
{
    ...
    public static class ContextManager
    {
        ...
        public static ObjectContext GetObjectContext(string contextKey)
        {
            ...
            {
                var dbcontext = new workorderEMSEntities();

                objectContext = ((System.Data.Entity.Infrastructure.IObjectContextAdapter)dbcontext).ObjectContext;
